...
exports.create = function(options, callback) {
  ...
  if (options.issuer) {
    var issuerObjects = doc.documentElement.getElementsByTagName('saml:Issuer');
  ...
  // For SAML assertion attributes
  doc.getElementsByTagName('saml:Assertion')[0]
  .setAttribute('ID', '_' + uuid)
  .setAttribute('IssueInstant', issueInstant);
